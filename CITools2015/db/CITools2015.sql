...
CREATE TABLE ROBOTDETAILS(
	...
	AUTO_MOVE_TO_AUTOZONE binary NULL,

	PICK_UP_TOTE int(1) NULL,
	PICK_UP_CONTAINER binary NULL,
	...
	CAN_CHUTE_TOTE binary NULL,
	CAN_CHUTE_LITTER binary NULL,

	STACK_TOTE int(1) NULL,
	CAN_STACK_CONTAINER binary NULL,
	CAN_STACK_LITTER binary NULL,
