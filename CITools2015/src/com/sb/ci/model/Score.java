...
public class Score extends BasePOJO {
	...
	static {
		...
		attributeMap.put(YELLOW_ZONE_PLACEMENT,
				Text.toCamel(YELLOW_ZONE_PLACEMENT));
		...
		attributeMap.put(KNOCK_CONTAINER_ROBOT,
				Text.toCamel(KNOCK_CONTAINER_ROBOT));
		...
		attributeMap.put(KNOCK_CONTAINER_STACK,
				Text.toCamel(KNOCK_CONTAINER_STACK));
