...
public class Insert {
	...
	public void checkTeamExists(String teamNumber) {
		...
		Collection<Team> test = find.findSomething("team", "teamNumber", teamNumber);
		Team testTeam = test.iterator().next();
	...
	public String buildParameters(String[] fields, BasePOJO pojo, String queryString){
	...
	public String buildValues(String[] fields, BasePOJO pojo, String queryString, Map data){
