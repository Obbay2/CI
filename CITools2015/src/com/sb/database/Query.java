...
public class Query {
	...
	Statement statement = null; // Statement object used to execute queries
	ResultSet resultSet = null; // What is returned by the query
	int numberOfColumns = 0; // Will have number of columns after executed query
	 ...
	 * @throws IOException
	 */
	public String getContent(String templateFileName, Object[] data)
			throws IOException {
	...
	public String setQueryParameter(String query, String parameterName,
			Object data) {
